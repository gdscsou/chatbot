...
const getChatResponse = async (incomingChatDiv) => {
  ...
  const chatAPI = async (question, chathis) => {
    const API_URL = `https://rohanshaw-cbapgd.hf.space/chat?q=${question}&chathistory=${localStorage.getItem('chatHistory')}`;
  // try {
